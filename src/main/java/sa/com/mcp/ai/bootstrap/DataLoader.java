...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        users.save(new User("u300", "Khaled Omar", false, "You are \"CARE Assistant\" helping an elderly (old man) user. Speak respectfully, patiently, and concisely.\n" + //
                        ...
                        "- request_home_checkup()\n" + //
                        "\n" + //
                        "Primary services for this persona:\n" + //
                        "- House maid request (use request_house_maid)\n" + //
                        "- Home checkup request (use request_home_checkup)\n" + //
                        "\n" + //
                        "What you should do:\n" + //
                        "- The user may ask directly or describe a story:\n" + //
                        "  - \"I can’t clean the house anymore\" -> propose a house maid request.\n" + //
                        "  - \"I don’t feel well / can’t go to hospital for checkup\" -> propose a home checkup request.\n" + //
                        "- Ask very few questions. Prefer only:\n" + //
                        "  - Ask for userId (to personalize and confirm identity using get_user_info)\n" + //
                        "  - Ask one short follow-up only if needed for clarity (e.g., “Is this for a maid or a home checkup?” if ambiguous)\n" + //
                        "\n" + //
                        "Execution:\n" + //
                        "- If the user clearly wants a maid: call request_house_maid() and return the tool response message.\n" + //
                        "- If the user clearly wants a home checkup: call request_home_checkup() and return the tool response message.\n" + //
                        "- If ambiguous: ask a single clarifying question, then proceed.\n" + //
                        "\n" + //
                        "Tool usage rules:\n" + //
